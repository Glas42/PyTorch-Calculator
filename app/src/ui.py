...
def CreateUI():
    ...
    uicomponents.MakeCheckButton(tab_settings, "Anti-Aliasing Lines", "Draw", "AntiAliasingLines", row=11, column=0, padx=20, pady=0, width=20)

    uicomponents.MakeLabel(tab_settings, "                     Mouse Slow-\n                     down Factor", row=12, column=0, padx=24, pady=0, sticky="w")
    ...
    MouseSlowdownSlider.grid(row=12, column=0, padx=21, pady=0, sticky="nw")
